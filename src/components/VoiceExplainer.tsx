...
const PAGE_EXPLANATIONS: Record<Language, Array<{ match: string; text: string }>> = {
  en: [
    ...
    { match: "/harvest", text: "This page gives harvest recommendations. It helps you understand whether to harvest now, wait, or protect the crop based on current conditions." },
    ...
    { match: "/calculator", text: "This profit calculator page helps you estimate farming income. You can enter yield, price, and costs to understand your expected profit." },
  ...
  ta: [
    ...
    { match: "/harvest", text: "இந்த பக்கம் அறுவடை பரிந்துரைகளை வழங்குகிறது. இப்போது அறுவடை செய்யலாமா, காத்திருக்கலாமா, அல்லது பயிரை பாதுகாக்க வேண்டுமா என்பதை புரிந்து கொள்ள உதவுகிறது." },
    ...
    { match: "/calculator", text: "இந்த லாப கணக்கீட்டு பக்கம் உங்கள் விவசாய வருமானத்தை கணிக்க உதவுகிறது. விளைச்சல், விலை, மற்றும் செலவுகளை உள்ளிட்டால் எதிர்பார்க்கும் லாபத்தை அறியலாம்." },
  ...
  hi: [
    ...
    { match: "/harvest", text: "यह पेज कटाई संबंधी सुझाव देता है। यह समझने में मदद करता है कि अभी कटाई करनी है, इंतजार करना है, या फसल की सुरक्षा करनी है।" },
    ...
    { match: "/calculator", text: "यह लाभ कैलकुलेटर पेज आपकी खेती की आय का अनुमान लगाने में मदद करता है। आप उत्पादन, कीमत और लागत भरकर संभावित लाभ जान सकते हैं।" },
